...
def shutdown(signum, frame):
    if log_file:
        ...
        log_file.close()
    if packet_file:
        packet_file.write("PACKETS INCOMPLETE\n")
        packet_file.close()
...
if __name__ == '__main__':
    ...
    try:
        ...
        exit('usage: ./sender.py <filename> <remote_IP> <remote_port> <ack_port_num> <log_filename> <packet_filename>')
    ...
    try:
        ...
        exit("Unable to open " + packet_filename)
    ...
    while True:
        try:
            ...
            #write raw ack packets to packet_file
            packet_file.write(ack)
